...
test("public assets and shell cache are versioned for reliable updates", () => {
  ...
  assert.match(homepage, /styles\.css\?v=20260802-5/);
  assert.match(homepage, /script\.js\?v=20260802-5/);
  assert.match(demo, /styles\.css\?v=20260802-5/);
  assert.match(demo, /product-demo\.js\?v=20260802-5/);
  assert.match(admin, /styles\.css\?v=20260802-5/);
  assert.match(admin, /admin\.js\?v=20260802-5/);
  assert.match(worker, /bizyako-shell-v10/);
  assert.match(worker, /20260802-5/);
